...
var InputAnnotation = langgraph_1.Annotation.Root({
    statement: (langgraph_1.Annotation),
});
var startNode = function (_state) {
    console.log("Start...");
    return { statement: "".concat(_state.statement, " I am") };
};
var happyNode = function (_state) {
    console.log("Happy Node");
    return { statement: "".concat(_state.statement, " happy") };
};
var sadNode = function (_state) {
    console.log("Sad Node");
    return { statement: "".concat(_state.statement, " sad") };
};
// The decideMode function will now be handled by edges
var decideMode = function (_state) {
    if (Math.random() < 0.5) {
...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, graph.invoke({ statement: '' })];
            case 1:
                result = _a.sent();
